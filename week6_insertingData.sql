...
INSERT INTO artwork VALUES
    ...
    (12, "Women in the Garden", 1886, "Impressionism", "Oil", "womengarden.jpg", 6),
...
VALUES
	(1, 1), -- artwork 1 has flowers
    
    (2, 2),-- artwork 2 has blue and landscape
    (2, 3),
    
    (3, 1), -- artwork 3 has flowers
    
    (4, 4), -- artwork 4 has girl, people, and battle
    (4, 5),
    (4, 6),
    
    (5, 7), -- artwork 5 has boat, water, people, and Christ
    (5, 8),
    (5, 5),
    (5, 9),
    
    (6, 4), -- artwork 6 has girl and people
    (6, 5),
    
    (7, 10), -- artwork 7 has food, people, and Christ
    (7, 5),
    (7, 9),
    
    (8, 4), -- artwork 8 has girl and people
    (8, 5),
    
    (9, 8), -- artwork 9 has water and landscape
    (9, 3),
    
    (10, 3), -- artwork 10 has landscape
    
    (11, 8), -- artwork 11 has water, people, and baby
    (11, 5),
    (11, 11),
    
    (12, 3), -- artwork 12 has landscape, people, and flowers
    (12, 5),
    (12, 1),
    
    (13, 2), -- artwork 13 has blue, and people
    (13, 5);
